 ...
 * Ne retourne que des solutions valides, sous forme de tableau, à partir d'une solution mère
 */
public final class Procedures {
   ...
   public static Solution[] neh(Solution mere) {
    ...
    /**
     * Prend chaque job, le place � tout les emplacements sur l'ordonnancement avant sa position actuelle (autres machines notamment)
     * Commence au deuxi�me job de l'ordo et fini au dernier job
     * @param mere
     * @param stage
     * @return
     */
